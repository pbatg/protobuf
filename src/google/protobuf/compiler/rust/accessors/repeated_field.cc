  ...
  ctx.Emit(
      {
          ...
          {"cpp_setter_thunk", ThunkName(ctx, field, "set")},
          {"setter",
           [&] {
             if (accessor_case == AccessorCase::VIEW) {
               return;
             ...
             [&] {
               if (ctx.is_upb()) {
                 ...
                 ctx.Emit(R"rs(
                    ...
                    fn $cpp_setter_thunk$(raw_msg: $pbr$::RawMessage, value: $pbr$::RawRepeatedField);
                  )rs");
               }
             }},
            {"clearer_thunk", ThunkName(ctx, field, "clear")}},
        ...
        [&] {
          ctx.Emit(
              R"cc(
                ...
                void $cpp_setter_thunk$($QualifiedMsg$* msg,
